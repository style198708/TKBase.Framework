using TKBase.Framework.Redis.Internal.Commands;
using System;
...
namespace TKBase.Framework.Redis.Internal
{
    class RedisTransaction
    {
        ...
        {
            TransactionQueued?.Invoke(this, new RedisTransactionQueuedEventArgs(response, command, args));
        }
    }
}
