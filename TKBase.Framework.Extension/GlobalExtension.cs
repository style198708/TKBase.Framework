...
namespace TKBase.Framework.Extension
{
    ...
    public static class GlobalExtension
    {
        ...
        public static int DefaultInt(this int? obj)
        {
            return obj.HasValue ? obj.Value : 0;
        }
        public static decimal DefaultDecimal(this decimal? obj)
        {
            return obj.HasValue ? obj.Value : decimal.Zero;
        }
        public static string DefaultString(this string obj)
        {
            return string.IsNullOrWhiteSpace(obj) ? "" : obj;
        }
        public static DateTime DefaultDateTime(this DateTime? obj)
        {
            return obj.HasValue ? obj.Value : DateTime.MinValue;
        }
