...
namespace TKBase.Framework.Enum
{
    /// <summary>
    /// 枚举属性扩展信息
    /// </summary>
    public static class EnumBaseExtentions
    {
        ...
        {
            return EnumBase.GetDescription(enumValue.GetType(), value,false);
        }
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string ToEnumString<T>(this int s) where T : EnumBase
        {
            return EnumBase.GetDescription(typeof(T), s, false);
        }
        /// <summary>
        /// 取值
        /// </summary>
        ...
        {
            if (s.HasValue)
                return EnumBase.GetDescription(typeof(T), s.Value,false);
            return "";
        }
    }
    ...
    public abstract class EnumBase
    {
        ...
        public static Dictionary<int, string> GetDictionary(Type type)
        {
            ...
            {
                dictionary.Add(Convert.ToInt32(field.GetValue(type)), GetDescription(field));
            }
        ...
        public static Dictionary<string, string> GetDictionaryString(Type type)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                {
                    throw new System.Exception(string.Format("{0},{1}已存在", type.ToString(), field.GetValue(type).ToString()));
                }
        ...
        public static Dictionary<string, string> GetDictionaryNameDesc(Type type)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                {
                    throw new Exception(string.Format("{0},{1}已存在", type.ToString(), field.GetValue(type).ToString()));
                }
        ...
        public static Dictionary<int, string[,]> GetAllDictionary(Type type)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                dictionary.Add( Convert.ToInt32(field.GetValue(type)), new string[,] { { GetDescription(field), field.Name } });
            }
        ...
        public static string GetName(Type type, BindingFlags flags, int? value)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == value) return field.Name;
            }
            return string.Empty;
        }
        ...
        public static string GetDescription(Type type, int? value)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == value) return GetDescription(field);
            }
        ...
        public static string GetDescriptionForm(Type type, object value)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == Convert.ToInt32(value)) return GetDescription(field);
            }
        ...
        public static string GetDescription(Type type, int value, bool isEng)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == value) return GetDescription(field, isEng);
            }
        ...
        public static string GetZHCNDescription(Type type, int value)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == value) return GetDescription(field, false);
            }
        ...
        public static string GetEngDescription(Type type, int value)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                if (Convert.ToInt32(field.GetValue(type)) == value) return GetDescription(field, true);
            }
