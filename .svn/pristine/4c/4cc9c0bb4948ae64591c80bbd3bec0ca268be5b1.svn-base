...
namespace TKBase.Framework.Dapper
{
    ...
    public struct CommandDefinition
    {
        ...
        internal IDbCommand SetupCommand(IDbConnection cnn, Action<IDbCommand, object> paramReader)
        {
            ...
            GetInit(cmd.GetType())?.Invoke(cmd);
            if (transaction != null)
...
#region Implementation of IDictionary<string,object>
        ...
        public static char ReadChar(object value)
        {
            ...
            if (!(value is string s) || s.Length != 1) throw new ArgumentException("A single-character was expected", "value");
            return s[0];
        }
            ...
            else
            {
                ...
                if (explicitConstr != null)
                {
                    ...
                    foreach(var p in consPs)
                    {
                        ...
                        {
                            if (!structLocals.TryGetValue(p.ParameterType, out LocalBuilder loc))
                            {
...
#pragma warning restore 618
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        object SqlMapper.IParameterLookup.this[string member]
        {
            get
            {
                return parameters.TryGetValue(member, out ParamInfo param) ? param.Value : null;
            }
        }
...
#pragma warning restore 612, 618
...
#endif
        {
            ...
            if (!(expression.Body is MemberExpression lastMemberAccess) ||
    ...
    sealed partial class CustomPropertyTypeMap : SqlMapper.ITypeMap
    {
        ...
        public CustomPropertyTypeMap(Type type, Func<Type, string, PropertyInfo> propertySelector)
        {
            ...
            _propertySelector = propertySelector ?? throw new ArgumentNullException("propertySelector");
        }
