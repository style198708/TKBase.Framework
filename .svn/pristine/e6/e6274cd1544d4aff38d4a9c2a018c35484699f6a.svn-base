...
namespace TKBase.DotNetty.Codecs
{
    ...
    /// <summary>
    ///     A decoder that splits the received <see cref="TKBase.DotNetty.Buffers.IByteBuffer" /> by one or more
    ///     delimiters.It is particularly useful for decoding the frames which ends
    ///     with a delimiter such as <see cref="TKBase.DotNetty.Codecs.Delimiters.NullDelimiter" /> or
    ///     <see cref="TKBase.DotNetty.Codecs.Delimiters.LineDelimiter" />
    ///     <h3>Specifying more than one delimiter </h3>
    ///     <see cref="TKBase.DotNetty.Codecs.Delimiters.NullDelimiter" /> allows you to specify more than one
    ...
    ///     | ABC\nDEF\r\n |
    ///     +--------------+
    ///     a <see cref="TKBase.DotNetty.Codecs.Delimiters.LineDelimiter" /> will choose '\n' as the first delimiter and produce two
    ///     frames:
    ///     +-----+-----+
    ///     | ABC | DEF |
    ///     +-----+-----+
    ...
    public class DelimiterBasedFrameDecoder : ByteToMessageDecoder
    {
        ...
        ///     NOTE: A see <see cref="TKBase.DotNetty.Codecs.TooLongFrameException" /> is thrown if the length of the frame exceeds this
        ///     value.
        /// </param>
        /// <param name="stripDelimiter">whether the decoded frame should strip out the delimiter or not</param>
        /// <param name="failFast">
        ///     If true, a <see cref="TKBase.DotNetty.Codecs.TooLongFrameException" /> is
        ///     thrown as soon as the decoder notices the length of the
        ///     frame will exceed<tt>maxFrameLength</tt> regardless of
        ///     whether the entire frame has been read.
        ///     If false, a <see cref="TKBase.DotNetty.Codecs.TooLongFrameException" /> is
        ...
        /// <summary>Create a frame out of the <see cref="TKBase.DotNetty.Buffers.IByteBuffer" /> and return it</summary>
        /// <param name="ctx">
        ///     the <see cref="TKBase.DotNetty.Transport.Channels.IChannelHandlerContext" /> which this
        ///     <see cref="TKBase.DotNetty.Codecs.ByteToMessageDecoder" /> belongs to
        /// </param>
        /// <param name="buffer">the <see cref="TKBase.DotNetty.Buffers.IByteBuffer" /> from which to read data</param>
        /// <returns>
        ///     the <see cref="TKBase.DotNetty.Buffers.IByteBuffer" /> which represent the frame or null if no frame could be
        ///     created.
        /// </returns>
