    ...
    public class TStreamTransport : TTransport
    {
        ...
        public override int Read(byte[] buf, int off, int len)
        {
           ...
           return  inputStream.Read(buf, off, len);
            ...
            //    return inputStream.Read(buf, off, Convert.ToInt32(inputStream.Length));
            //}
            //catch(Exception ex)
            //{
              
            //   throw new TTransportException(TTransportException.ExceptionType.NotOpen, "Cannot read from 0 Lenth Byte inputstream"); ;
            //}  
        }
