...
namespace TKBase.DotNetty.Transport.Channels
{
    ...
    using  TKBase.DotNetty.Common.Internal.Logging;
    ...
    public class DefaultChannelPipeline : IChannelPipeline
    {
        ...
        sealed class TailContext : AbstractChannelHandlerContext, IChannelHandler
        {
            ...
            static new readonly SkipFlags SkipFlags = CalculateSkipPropagationFlags(typeof(TailContext));
        ...
        sealed class HeadContext : AbstractChannelHandlerContext, IChannelHandler
        {
            ...
            static new readonly SkipFlags SkipFlags = CalculateSkipPropagationFlags(typeof(HeadContext));
