...
namespace TKBase.Framework.Dapper
{
    ...
    public class DataUtils
    {
        ...
        private static readonly System.Text.RegularExpressions.Regex keyReg = new System.Text.RegularExpressions.Regex("[^a-zA-Z]", System.Text.RegularExpressions.RegexOptions.Compiled);
        private static readonly RNGCryptoServiceProvider rng = new RNGCryptoServiceProvider();
        private static readonly byte[] bt = new byte[5];
