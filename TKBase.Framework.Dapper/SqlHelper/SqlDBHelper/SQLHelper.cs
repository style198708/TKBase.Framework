...
namespace TKBase.Framework.Dapper.SqlDBHelper
{
    /// <summary>
    /// 封装数据库的基本操作
    /// </summary>
    ...
    public class SQLHelper
    {
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string commandText, List<IDataParameter> commandParameters = null, CommandType commandType = CommandType.Text, int? commandTimeout = null)
        {
            ...
            PrepareCommand(cmd, connection, (SqlTransaction)null, commandType, commandText, out bool mustCloseConnection, commandParameters, commandTimeout);
        ...
        public static int ExecuteNonQuery(IDbTransaction transaction, string commandText, List<IDataParameter> commandParameters = null, CommandType commandType = CommandType.Text, int? commandTimeout = null)
        {
            //要检查参数  
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, ((SqlTransaction)transaction).Connection, (SqlTransaction)transaction, commandType, commandText, out bool mustCloseConnection, commandParameters, commandTimeout);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, (SqlConnection)transaction.Connection, (SqlTransaction)transaction, commandType, commandText, out bool mustCloseConnection, commandParameters, commandTimeout);
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
                DataSet ds = new DataSet();
                da.Fill(ds);
