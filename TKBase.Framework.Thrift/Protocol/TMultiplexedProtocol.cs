...
namespace TKBase.Framework.Thrift.Protocol
{
    ...
    /**
     * TMultiplexedProtocol is a protocol-independent concrete decorator that allows a TKBase.Framework.Thrift
     * client to communicate with a multiplexing TKBase.Framework.Thrift server, by prepending the service name
