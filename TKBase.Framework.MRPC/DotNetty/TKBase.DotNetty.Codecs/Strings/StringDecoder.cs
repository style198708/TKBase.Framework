...
namespace TKBase.DotNetty.Codecs
{
    ...
    */
    ...
    public class StringDecoder : MessageToMessageDecoder<IByteBuffer>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TKBase.DotNetty.Codecs.StringDecoder" /> class with the current system
        ///     character set.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TKBase.DotNetty.Codecs.StringDecoder" /> class with the specified character
        ///     set..
        /// </summary>
